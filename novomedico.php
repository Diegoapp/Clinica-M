...
$statement = $pdo->prepare('INSERT INTO medicos(crm_medico, nome_medico, conselho_medico, uf_crm_medico, cbo_medico, senha_medico) VALUES (:crm_medico, :nome_medico, :conselho_medico, :uf_crm_medico, :cbo, :senha_medico)');
